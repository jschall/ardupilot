...
void AC_AttitudeControl::angle_ef_roll_pitch_rate_ef_yaw_smooth(float roll_angle_ef, float pitch_angle_ef, float yaw_rate_ef, float smoothing_gain)
{
    ...
    if (_accel_rp_max > 0.0f) {
        ...
        rate_ef_desired = sqrt_filter(roll_angle_ef, _angle_ef_target.x, smoothing_gain, _accel_rp_max);
        ...
        rate_ef_desired = sqrt_filter(pitch_angle_ef, _angle_ef_target.y, smoothing_gain, _accel_rp_max);
