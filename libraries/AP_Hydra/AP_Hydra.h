...
{
public:
    virtual void set_torque(float torque_out) { _torque_out = (int16_t)constrain_float(torque_out,-32767.0f,32767.0f); }
    virtual float get_rotor_pos_rad() { return _rotor_pos_rad; }
