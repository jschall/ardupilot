...
#ifndef AC_QUATERNION_H
#define AC_QUATERNION_H
...
public:
    ...
    // setting constructor
    AC_Quaternion(const float _q1, const float _q2, const float _q3, const float _q4) :
    ...
    AC_Quaternion inverse(void) const;
    ...
    AC_Quaternion operator*(AC_Quaternion v);
    AC_Quaternion &operator*=(AC_Quaternion v);
};
#endif // AC_QUATERNION_H
