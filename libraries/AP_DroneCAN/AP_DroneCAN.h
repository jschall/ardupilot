...
private:
    ...
    Canard::ObjCallback<AP_DroneCAN, com_volz_servo_ActuatorStatus> actuator_status_Volz_cb{this, &AP_DroneCAN::handle_actuator_status_Volz};
