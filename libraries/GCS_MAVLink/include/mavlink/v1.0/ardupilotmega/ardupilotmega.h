...
/** @brief  */
#ifndef HAVE_ENUM_LED_POSITIONS
#define HAVE_ENUM_LED_POSITIONS
typedef enum LED_POSITIONS
{
	LED_POSITION_BACK_LEFT=0, /*  | */
	LED_POSITION_BACK_RIGHT=1, /*  | */
	LED_POSITION_FRONT_RIGHT=2, /*  | */
	LED_POSITION_FRONT_LEFT=3, /*  | */
	LED_POSITION_ALL=255, /*  | */
	LED_POSITIONS_ENUM_END=256, /*  | */
} LED_POSITIONS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LED_CONTROL_PATTERNS
#define HAVE_ENUM_LED_CONTROL_PATTERNS
typedef enum LED_CONTROL_PATTERNS
{
	LED_CONTROL_PATTERN_OFF=0, /*  | */
	LED_CONTROL_PATTERN_BREATHE=1, /*  | */
	LED_CONTROL_PATTERN_SOLID=2, /*  | */
	LED_CONTROL_PATTERN_SIREN=3, /*  | */
	LED_CONTROL_PATTERN_STROBE=4, /*  | */
	LED_CONTROL_PATTERN_AVIATION_STROBE=5, /*  | */
	LED_CONTROL_PATTERN_FADEIN=6, /*  | */
	LED_CONTROL_PATTERN_FADEOUT=7, /*  | */
	LED_CONTROL_PATTERN_STOP=255, /* LED patterns off (return control to regular vehicle control) | */
	LED_CONTROL_PATTERNS_ENUM_END=256, /*  | */
} LED_CONTROL_PATTERNS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LED_CONTROL_PARAMS
#define HAVE_ENUM_LED_CONTROL_PARAMS
typedef enum LED_CONTROL_PARAMS
{
	LED_CONTROL_PARAM_BIAS_RED=0, /* Bias of the red LED brightness | */
	LED_CONTROL_PARAM_BIAS_GREEN=1, /* Bias of the green LED brightness | */
	LED_CONTROL_PARAM_BIAS_BLUE=2, /* Bias of the blue LED brightness | */
	LED_CONTROL_PARAM_AMPLITUDE_RED=3, /* Amplitude of the red LED brightness | */
	LED_CONTROL_PARAM_AMPLITUDE_GREEN=4, /* Amplitude of the green LED brightness | */
	LED_CONTROL_PARAM_AMPLITUDE_BLUE=5, /* Amplitude of the blue LED brightness | */
	LED_CONTROL_PARAM_PERIOD=6, /* Pattern period (milliseconds) | */
	LED_CONTROL_PARAM_REPEAT=7, /* Numer of pattern cycles to run | */
	LED_CONTROL_PARAM_PHASEOFFSET=8, /* Pattern phase-offset (degrees) | */
	LED_CONTROL_PARAMS_ENUM_END=9, /*  | */
} LED_CONTROL_PARAMS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LED_CONTROL_MACROS
#define HAVE_ENUM_LED_CONTROL_MACROS
typedef enum LED_CONTROL_MACROS
{
	LED_CONTROL_MACRO_FWUPDATE=1, /*  | */
	LED_CONTROL_MACRO_BREATHE=2, /*  | */
	LED_CONTROL_MACRO_FADE_OUT=3, /*  | */
	LED_CONTROL_MACRO_AMBER=4, /*  | */
	LED_CONTROL_MACRO_WHITE=5, /*  | */
	LED_CONTROL_MACRO_AUTOMOBILE=6, /*  | */
	LED_CONTROL_MACRO_AVIATION=7, /*  | */
	LED_CONTROL_MACROS_ENUM_END=8, /*  | */
} LED_CONTROL_MACROS;
#endif
...
#include "./mavlink_msg_led_control_pattern.h"
#include "./mavlink_msg_led_control_pattern_param.h"
#include "./mavlink_msg_led_control_macro.h"
