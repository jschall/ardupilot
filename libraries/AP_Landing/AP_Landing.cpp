...
const AP_Param::GroupInfo AP_Landing::var_info[] = {
    ...
    // @Bitmask: 0: honor min throttle during landing flare,1: Increase Target landing airspeed constraint From Trim Airspeed to AIRSPEED_MAX,2: Treat LAND waypoint as the flare point
    // @User: Advanced
