...
#include <AC_AccelControl/AC_AccelControl.h>
...
# include USERHOOK_VARIABLES
    ...
    union {
        struct {
            ...
            uint8_t motor_interlock_request : 1; // 23      // true if pilot is requesting motor interlock enable
