...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Rudder mixing in direct flight modes only (Manual / Stabilize / Acro),1:Use centered throttle in Cruise or FBWB to indicate trim airspeed, 2:Disable attitude check for takeoff arming, 3:Force target airspeed to trim airspeed in Cruise or FBWB, 4:Throttle stick will nudge speed target up and down between ARSPD_FBW_MIN and ARSPD_FBW_MAX in FBWB and CRUISE modes.
    // @User: Advanced
