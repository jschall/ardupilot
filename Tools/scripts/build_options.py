...
BUILD_OPTIONS = [
    ...
    Feature('Sensors', 'RPM_HARMONIC_NOTCH', 'AP_RPM_HARMONICNOTCH_ENABLED', 'Enable RPM Harmonic Notch sensors', 0, 'RPM'),  # noqa
    ...
    Feature('Actuators', 'VESC_DroneCAN', 'AP_DRONECAN_VESC_FEEDBACK_ENABLED', 'Enable VESC DroneCAN Feedback', 0, None),
